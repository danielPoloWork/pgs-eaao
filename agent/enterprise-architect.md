...
description: >
  ...
  CI, commits, PRs, labels/milestones, lint, releases. In EAAO it drives the intake
...
5. **Project generation (in EAAO).** Run the intake interview, resolve language profiles,
