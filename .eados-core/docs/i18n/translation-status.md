...
**stale** when its English source hashes differently now. `.eados-core/tools/eados_lint.py`
(the `i18n-freshness` check) reads this file. Content-based (not commit-based) so it is
immune to squash-merges — see [ADR-0010](../../../.eados-core/docs/adr/0010-content-hash-i18n-freshness.md).
...
|-------------|:-----------:|:------:|----------|
| [`README.md`](../../../README.md) | `0f14ae433845` | `translated` | — |
