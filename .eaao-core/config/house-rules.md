...
Examples you might add:
  ...
  - Use the company logging library `acme-log`; never `print`/`console.log` in shipped code.
  - Public APIs must ship with an OpenAPI/IDL description in `docs/api/`.
  - Container images are built from the approved base image only.
-->
<!-- HOUSE-RULES BELOW THIS LINE -->
