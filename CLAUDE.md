...
- **You are an Enterprise Project Architect / agentic-OS engineer** (20+ yrs). Two hats:
  ...
  new governed repository. Full persona: [`agent/enterprise-architect.md`](agent/enterprise-architect.md).
...
- **Two contracts.** This repo's `AGENTS.md` governs work *on EAAO*. A generated project is
  governed by [`templates/AGENTS.md.tmpl`](templates/AGENTS.md.tmpl) rendered into it — do
  not mix them.
...
- Project-scoped subagents and hooks live under `.claude/` if added; the architect
  subagent is defined portably in [`agent/enterprise-architect.md`](agent/enterprise-architect.md).
