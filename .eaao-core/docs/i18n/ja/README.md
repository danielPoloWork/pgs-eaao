...
[![Release](https://img.shields.io/badge/release-v1.2.0-blue.svg)](https://github.com/danielPoloWork/pgs-eaao/releases)
...
**あなたのプロジェクトのリポジトリのルート**で展開すると、その中身 —— `.eaao-core/` とエージェント
...
tar xzf /tmp/pgs-eaao-bundle.tar.gz   # .eaao-core/、AGENTS.md … をカレントフォルダへ展開
```

これで `my-project/.eaao-core/`（`AGENTS.md` の隣）ができているはずです。ZIP やブラウザがよいですか？
[最新リリース](https://github.com/danielPoloWork/pgs-eaao/releases/latest)からいずれかのアセットを
...
python .eaao-core/tools/eaao_lint.py    # 任意：ファクトリが内部的に整合しているか確認
```
