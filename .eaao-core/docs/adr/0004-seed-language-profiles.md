...
EAAO is open to any language: a profile can be authored on demand from
...
primary application languages: EAAO's project model (build/test/lint, a version constant, a
